...
email_failed = "apereira@coaktion.com"
...
def _load():
    ...
    engine_postgresql_olap = sqlalchemy.create_engine('postgres+psycopg2://postgres:airflow@172.17.04:5432/employees')
